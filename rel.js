...
contract RELToken is StandardToken {

    string public name = "REL Token";
    string public symbol = "REL";
    ...
    bool public preIco = false; //PreICO stage
    bool public stageIco = true; //ICO stage
     ...
     * PreICO end time
     */    
     uint256 public preIcoEndTime = 1523198912; // PreICO end time is Sunday, April 8, 2018 9:48:32 AM GMT-05:00
    ...
    function RELToken(address _founder) payable {
        owner = msg.sender;
        founder = _founder;
    ...
    /**
     * 1 REL = 1200000000000000 WEI
     * Price is 820 REL for 1 ETH
     */
    function price() constant returns (uint) {
        return 1200000000000000 wei;
    }
